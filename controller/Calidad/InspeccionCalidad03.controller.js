sap.ui.define([
    ...
    var DocumentoGlobal = '';
    var centro;
    return BaseController.extend("sap.ui.demo.webapp.controller.Calidad.InspeccionCalidad03", {
        formatter: formatter,

        onInit: function () {
            var oRouter = this.getRouter();
            oRouter.getRoute("InspeccionCalidad03").attachMatched(this._onRouteMatched, this);
        },
        ...
        onSearch: function (oEvent) {
            ...
            if ((fecha_in == "" || fecha_in == undefined) && (fecha_fin == "" || fecha_fin == undefined)) {
                ...
                this._base_onloadTable('insplot_list', oData, 'MII/DatosTransaccionales/Calidad/Transaction/get_insplot_03', "Lotes de inspeccion", "");
            }
        },
        ...
        onInspeccion: function (oEvent) {
            ...
            this.getRouter().navTo("Inspecciones", {
                centro: centro,
