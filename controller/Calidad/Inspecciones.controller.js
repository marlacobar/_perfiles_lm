sap.ui.define([
	...
	var centro;
	return BaseController.extend("sap.ui.demo.webapp.controller.Calidad.Inspecciones", {
		...
		onInit: function () {
			...
			oRouter.getRoute("Inspecciones").attachMatched(this._onRouteMatched, this);
		},
		...
		_onRouteMatched: function (oEvent) {
			...
			this._base_onloadHeader(aData, "MII/DatosTransaccionales/Calidad/Transaction/get_info_lote_inspeccion","Cabecera", "");
			...
			this._base_onloadCOMBO("listOperation", xData, "MII/DatosTransaccionales/Calidad/Transaction/get_operation", "",
				"Operaciones");
		},
		...
		onInspeccionMultiple: function (oEvent) {
			...
			this._base_onloadTable("insplot_multiple", oData, "MII/DatosTransaccionales/Calidad/Transaction/get_insplot_multiple", "lotes", "");
		...
		onChangeOperations: function (oEvent) {
			...
			oThis.sleep(500).then(() => {
				oThis._base_onloadHeader(aData, "MII/DatosTransaccionales/Calidad/Transaction/get_info_lote_inspeccion", "Cabecera");

				oThis._base_onloadTable_post("charListQM", aData, "MII/DatosTransaccionales/Calidad/Transaction/get_chars_calidad", "Chars", "", function () {
		...
		*/
		...
		onDEMultiInspeccionar: function () {
			...
			this._base_onloadCOMBO("Combo_decisionMULTI", oData, "MII/DatosTransaccionales/Pedidos/Transaction/get_codes_desition", "");
			...
			this._base_onloadTable("Tabla_LotesDE", oData, "MII/DatosTransaccionales/Calidad/Transaction/get_insplot_multiple", "lotes", "");
			oDialog.open();
		},
