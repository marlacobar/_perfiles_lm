...
sap.ui.define([
    ...
    return Controller.extend("sap.ui.demo.webapp.controller.BaseController", {
		...
		if (name_view !== null) {
                        ...
                        oThis._setModeloObjetos(oData,path);
                    }
                },
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                    console.log("ERROR");
        ...
        _setModeloObjetos(oData, path) {
            var oThis = this;
            var url = "/XMII/Runner?Transaction=" + path + "&OutputParameter=JsonOutput&Content-Type=text/xml";
		...
		_LoadQuery:function(oData,oPath,id){
			var oThis =this;
			var oModelMAT = new sap.ui.model.json.JSONModel();
			var empty = new sap.ui.model.json.JSONModel();
			var data = new sap.ui.model.json.JSONModel();
